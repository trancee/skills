...
| Skill | Context tokens | Purpose |
| --- | ---: | --- |
| [`android-ble`](android-ble/) | 6,417 | Implement, migrate, test, and troubleshoot Android BLE scanning, GATT lifecycle, background, permissions, and Android 17 behavior. |
